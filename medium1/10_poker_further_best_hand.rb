...
puts pair > high_card
puts royal_flush > straight_flush
puts flush > three_of_a_kind
puts straight_flush > four_of_a_kind

hands_best_to_worst = [royal_flush, straight_flush, four_of_a_kind, full_house, flush, straight, three_of_a_kind, two_pair, pair, high_card]
puts hands_best_to_worst.shuffle.sort.reverse == hands_best_to_worst
